      ...
      <div className="w-full px-6 sm:px-8 lg:px-12 xl:px-16 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1.2fr] gap-8 lg:gap-12">
          ...
          <nav aria-label="Footer Navigation">
            <h4 className="font-display font-semibold mb-4 text-inherit">
              Navigation
            </h4>
            <ul className="space-y-3" role="list">
              ...
              <li>
                <Link to="/ki-check" className="transition-colors text-sm px-2 py-0.5 bg-accent text-accent-foreground font-bold rounded">
                  KI-Check
                </Link>
              </li>
              <li>
