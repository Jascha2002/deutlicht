  ...
  const questions: Question[] = [
    {
      ...
      options: [
        { value: 'micro', label: '1-10 Mitarbeitende', points: 2 },
        { value: 'small', label: '11-50 Mitarbeitende', points: 3 },
        { value: 'medium', label: '51-250 Mitarbeitende', points: 4 },
        { value: 'large', label: 'Über 250 Mitarbeitende', points: 3 }
      ]
    },
    {
      id: 'repetitive_tasks',
      ...
      options: [
        { value: 'minimal', label: 'Kaum (unter 10%)', points: 1 },
        { value: 'some', label: 'Etwas (10-25%)', points: 3 },
        { value: 'significant', label: 'Viel (25-50%)', points: 5 },
        { value: 'excessive', label: 'Sehr viel (über 50%)', points: 5 }
      ]
    },
    {
      ...
      options: [
        { value: 'few', label: 'Weniger als 10', points: 2 },
        { value: 'moderate', label: '10-50', points: 4 },
        { value: 'many', label: '50-200', points: 5 },
        { value: 'massive', label: 'Über 200', points: 5 }
      ]
    },
    {
      ...
      options: [
        { value: 'outdated', label: 'Veraltet, viele manuelle Prozesse', points: 5 },
        { value: 'basic', label: 'Grundlegend, aber funktional', points: 4 },
        { value: 'modern', label: 'Modern, aber nicht integriert', points: 3 },
        { value: 'advanced', label: 'Hochmodern und gut integriert', points: 2 }
      ]
    },
    {
      id: 'data_protection',
      ...
      options: [
        { value: 'critical', label: 'Absolut kritisch (z.B. Kanzlei, Gesundheit)', points: 5 },
        { value: 'very_important', label: 'Sehr wichtig', points: 4 },
        { value: 'important', label: 'Wichtig', points: 3 },
        { value: 'standard', label: 'Standard-Anforderungen', points: 2 }
      ]
    },
    {
      id: 'team_openness',
      ...
      options: [
        { value: 'resistant', label: 'Eher skeptisch', points: 2 },
        { value: 'cautious', label: 'Vorsichtig offen', points: 3 },
        { value: 'open', label: 'Offen und interessiert', points: 4 },
        { value: 'enthusiastic', label: 'Sehr enthusiastisch', points: 5 }
      ]
    },
    {
      id: 'budget',
      ...
      options: [
        { value: 'limited', label: 'Unter 500€', points: 2 },
        { value: 'moderate', label: '500-2.000€', points: 3 },
        { value: 'good', label: '2.000-5.000€', points: 4 },
        { value: 'substantial', label: 'Über 5.000€', points: 5 }
      ]
    },
    {
      id: 'main_pain_point',
      ...
      options: [
        { value: 'efficiency', label: 'Zu viele manuelle Prozesse', points: 5 },
        { value: 'customer_service', label: 'Kundenkommunikation überfordert uns', points: 5 },
        { value: 'data_chaos', label: 'Daten sind überall verstreut', points: 4 },
        { value: 'competition', label: 'Wettbewerber sind technologisch voraus', points: 4 }
      ]
    },
    {
      id: 'timeline',
      ...
      options: [
        { value: 'urgent', label: 'Sofort/Nächsten Monat', points: 5 },
        { value: 'soon', label: 'In 1-3 Monaten', points: 4 },
        { value: 'planning', label: 'In 3-6 Monaten', points: 3 },
        { value: 'exploring', label: 'Nur Information sammeln', points: 1 }
      ]
    },
    {
      id: 'goals',
      ...
      options: [
        { value: 'cost_reduction', label: 'Kosten senken', points: 3 },
        { value: 'quality', label: 'Servicequalität verbessern', points: 4 },
        { value: 'growth', label: 'Wachstum ermöglichen', points: 5 },
        { value: 'competitive', label: 'Wettbewerbsfähig bleiben', points: 4 }
      ]
    }
  ];

  const handleAnswer = (value: string, points: number) => {
    setAnswers({ ...answers, [questions[currentQuestion].id]: { value, points } });
  };
  ...
  const getRecommendation = (): Recommendation => {
    ...
    if (percentage >= 80) {
      return {
        ...
        priorities: [
          'KI-gestützter Kundensupport (WhatsApp/Telefon)',
          'Prozessautomatisierung mit Odoo-Integration',
          'Intelligentes CRM mit Lead-Scoring'
        ],
        bundle: 'Premium KI-Paket',
        roi: '6-9 Monate',
        nextSteps: [
          'Kostenloses Erstgespräch vereinbaren',
          'Quick-Win-Analyse Ihrer Prozesse',
      ...
      return {
        ...
        priorities: [
          ...
          'Schrittweise Automatisierung starten'
        ],
        bundle: 'Starter KI-Paket',
        roi: '9-12 Monate',
        nextSteps: [
          'KI-Strategie-Workshop (kostenlos)',
          'Quick-Win identifizieren',
          'Pilotprojekt mit kleinem Bereich starten'
        ]
      };
      ...
      return {
        ...
        priorities: [
          ...
          'Team für Digitalisierung vorbereiten'
        ],
        bundle: 'Digital-Fundament-Paket',
        roi: '12-18 Monate',
        nextSteps: [
          'Digitalisierungs-Roadmap erstellen',
          'Infrastruktur-Audit durchführen',
          'Basisautomatisierung ohne KI starten'
        ]
      };
    } else {
      return {
        ...
        priorities: [
          ...
          'Team mitnehmen und schulen'
        ],
        bundle: 'Digitalisierungs-Beratung',
        roi: '18-24 Monate',
        nextSteps: [
          'Kostenlose Potenzialanalyse',
          'Digitalisierungs-Fahrplan entwickeln',
          'Mit einfachen Verbesserungen starten'
        ]
      };
    }
  };
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-2xl p-6 mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-blue-500 focus:outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                />
                <button
                  onClick={() => alert('In der Live-Version wird hier die E-Mail an Ihr CRM gesendet!')}
          ...
          <div className="p-6 md:p-8">
                ...
                <button
                  ...
                  className={`w-full p-4 rounded-xl border-2 text-left transition-all ${
                    currentAnswer?.value === option.value
                      ...
                      : 'border-gray-200 dark:border-gray-600 hover:border-blue-300 hover:bg-blue-50 dark:hover:bg-blue-950'
                  }`}
                >
            ...
            <div className="flex justify-between gap-4">
              ...
              <button
                ...
                className={`flex items-center gap-2 px-8 py-3 rounded-xl font-semibold transition-all ml-auto ${
                  currentAnswer
